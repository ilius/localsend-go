...
//
// I wanted to switch to my stripansi package (github.com/MatusOllah/stripansi)
// but I'm worried that I might get backlash from it for adding another

// dependency :/ Go check it out, it's really awesome ;)
